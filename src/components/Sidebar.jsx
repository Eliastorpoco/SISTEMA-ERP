...
const NAV_ITEMS = [
  ...
  { label:'Calificaciones Aula Virtual', to:'/aula-virtual/reporte-pedagogico', group:'Aprendizaje', roles:['DIRECTOR','ADMIN','DOCENTE'],
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5"><path d="M4 19V5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2z"/><path d="M8 15l2-2 2 1 4-5"/><path d="M8 7h4"/></svg> },
